...
Время работы алгоритма для выборки из 100_000 векторов составило 32 минуты (10 минут поиск `FAISS` и 22 минуты на инференс(включая генерацию фич для тестовой выборки) на i5-9600K для выборки
